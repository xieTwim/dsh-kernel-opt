...
function challengeText(round, evalsDone, budget, advice, finalizeHint = "run_finalize / kernel_finalize", evalsPerTurn = 0) {
	const lines = [
		...
		advice,
		"",
		`${CONTINUE_TRAILER}: the run is NOT over. You declared it finished, but budget remains and the supervisor identified headroom above — treat your finalize as provisional and pursue those directions now.`,
