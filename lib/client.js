	...
	factory: (require) => {
		...
		*/
		function eligibleBest(point) {
			return point.correct === true && point.rewardHack !== true && point.error === void 0 && point.latencyMs !== void 0;
		}
		/**
		...
		*/
		function bestSoFar(measured) {
			const out = [];
			let best;
			for (const point of measured) {
				if (eligibleBest(point) && (best === void 0 || point.latencyMs < best)) best = point.latencyMs;
				out.push(best);
			}
			return out;
		}
...
`;
		...
		*/
		function useArrivals(iterations) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
				/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
					...
					children: [
						...
						Math.abs(CHART.t - bestY) >= 18 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("text", {
							x: CHART.l - 8,
							y: CHART.t + 5,
							textAnchor: "end",
							fontSize: 13,
						...
						Math.abs(CHART.h - CHART.b - bestY) >= 18 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("text", {
							x: CHART.l - 8,
							y: CHART.h - CHART.b,
							textAnchor: "end",
							fontSize: 13,
						...
						model.log ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("text", {
							x: CHART.l - 8,
							y: (CHART.t + CHART.h - CHART.b) / 2 + 16,
							textAnchor: "end",
							fontSize: 12,
							fill: COLOR.caption,
							children: "log"
						...
						[
							...
							return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("g", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("line", {
								...
								strokeDasharray: "2 5",
								opacity: .55
							}), f === .5 && Math.abs(gy - bestY) >= 18 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("text", {
								x: CHART.l - 8,
								y: gy + 4,
								textAnchor: "end",
								fontSize: 12,
						...
						bestPath !== "" ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("g", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("title", { children: bestSoFarLabel }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("path", {
							d: bestPath,
							fill: "none",
							stroke: COLOR.ok,
							strokeWidth: 2.5,
						...
						best?.latencyMs !== void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("text", {
							x: CHART.l - 8,
							y: bestY + 5,
							textAnchor: "end",
							fontSize: 14,
						...
						iterations.map((p, i) => {
							...
							return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("g", { children: [
								...
								fresh && isBest ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("circle", {
								...
								status === "ok" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("circle", {
									...
									cx,
									cy,
									r: isBest || finalPick ? 6.5 : 4.5,
									fill: color,
									stroke: isBest || finalPick ? COLOR.halo : void 0,
									strokeWidth: isBest || finalPick ? 2 : void 0,
									style: fresh ? {
								...
								finalPick || isBest && !hasFinalPick ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("g", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("line", {
									x1: cx,
									x2: cx,
									y1: cy + 8,
									y2: CHART.h - CHART.b,
									...
									strokeWidth: 3.5,
									paintOrder: "stroke",
									children: finalPick && isBest ? markLabels.bestFinal : finalPick ? markLabels.final : markLabels.best
								})] }) : null
							] }, `${String(p.seq)}-${String(i)}`);
						}),
						profileXs.map((x, i) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("text", {
							x,
							y: CHART.h - CHART.b + 15,
							textAnchor: "middle",
							fontSize: 12,
							fill: COLOR.caption,
							children: "▲"
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { style: {
								width: 14,
								height: 0,
								borderTop: `1.5px solid ${COLOR.curve}`,
								opacity: .7
							} }), legend.candidate]
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { style: {
								...
								height: 8,
								borderRadius: 999,
								border: `1.5px solid ${COLOR.bad}`
							} }), legend.rejected]
						})
					]
				}),
				model.referenceMs !== void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					style: {
						display: "flex",
						flexWrap: "wrap",
						gap: 10,
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: axisShort }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						style: {
							cursor: "help",
							color: COLOR.curve
						},
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								...
								children: t(headline.finalized ? "hero.final" : "hero.running")
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								style: {
									fontSize: 60,
								...
								children: ratio !== void 0 ? `×${ratio.toPrecision(3)}` : formatLatency(claim.latencyMs)
							}),
							referenceMs !== void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								style: {
									fontSize: 15,
									color: COLOR.dim,
									fontVariantNumeric: "tabular-nums"
								},
								children: t("hero.from", {
									reference: formatLatency(referenceMs),
									latency: formatLatency(claim.latencyMs)
								})
							}) : null,
							claim.artifactPath !== void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								style: {
									fontSize: 13,
									color: COLOR.caption,
									marginTop: 4,
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: ["✓ ", t("hero.passed")]
							}),
							claim.rewardHack !== true ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								style: {
									fontSize: 14,
									color: COLOR.ok
								},
								children: ["✓ ", t("hero.noHack")]
							}) : null,
		...
		*/
		...
		function KernelOptTab(props) {
			...
			series !== null && series.bestIndex !== null && iterations[series.bestIndex];
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
						...
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									control !== void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										style: {
											fontSize: 13,
											color: COLOR.curve,
											cursor: "pointer",
					...
					empty ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsx)(Hero, {
						headline,
					...
					iterations.length > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								overBudgetEvals > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
									style: { color: COLOR.warn },
									title: t("tip.overBudget"),
									children: ["· ", t("chips.overBudget", { count: overBudgetEvals })]
								}) : null,
								wrapUpChecks > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
									title: t("tip.wrapup"),
									children: ["· ", t("chips.wrapup", { count: wrapUpChecks })]
								}) : null,
								series !== null && series.profileSeqs.length > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: ["· ", t("chips.profiles", { count: series.profileSeqs.length })] }) : null,
								hackCount > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
									style: {
										color: COLOR.warn,
										fontWeight: 500
									},
