	...
	factory: (require) => {
		...
		*/
		...
		const zh = {
			...
			"status.error": "失败",
			"axis.best": "最佳",
			"loop.armed": "循环运行中 · 已评测 {done}/{budget} 次",
			"loop.stopped": "循环已停止：{reason}",
			"pop.budget": "评测次数",
			"pop.supervise": "外部监督",
			"pop.model": "监督模型",
			"pop.supNote": "已开启：循环每次驱动 Agent 继续之前，监督模型会先复审当前进展，建议自动转交 Agent。",
			"pop.footer": "启动后 Agent 立即开始工作；每当一段工作结束而任务尚未完成，循环会自动驱动它继续，直到评测次数达到上限。输入框中的草稿不会被自动发送；优化曲线与完整记录见「评测」页。",
			"sup.on": "on",
			"sup.off": "off",
		...
		const en = {
			...
			"status.error": "failed",
			"axis.best": "best",
			"loop.armed": "loop running · {done}/{budget} evaluations",
			"loop.stopped": "loop stopped: {reason}",
			"pop.budget": "Max evaluations",
			...
			"pop.footer": "Starting puts the agent to work immediately; whenever it stops with the task unfinished, the loop drives it onward until the evaluation limit is reached. Composer drafts are never auto-sent; the curve and full record live on the Evaluations tab.",
			"sup.on": "on",
			"sup.off": "off",
			...
			"reason.budget": "evaluation limit reached, wrap-up requested",
		...
		*/
		function SuperviseToggle(props) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
				type: "button",
				style: {
					...buttonStyle(enabled ? COLOR.warn : void 0),
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							control !== void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								style: {
									display: "flex",
									flexWrap: "wrap",
									gap: 8,
							...
							iterations.length > 0 || series !== null && series.profileSeqs.length > 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								style: {
									display: "flex",
									flexWrap: "wrap",
									gap: 8,
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
					...
					children: [
						...
						control.supervisor.enabled ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							style: {
								fontSize: 12,
								lineHeight: "18px",
								color: COLOR.caption
							},
							children: t("pop.supNote")
						}) : null,
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							style: popoverRowStyle,
