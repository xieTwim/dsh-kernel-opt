	...
	factory: (require) => {
		...
		*/
		function SupervisorSelect(props) {
			...
			const defaultLabel = configRoute !== void 0 ? t("sup.default", { route: `${configRoute.provider}/${configRoute.model}` }) : t("sup.pick");
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("select", {
				...
				children: [
					...
					providers.map((provider) => provider.models.map((model) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
								...
								children: [
									...
									control !== void 0 && control.loop.armed === false && control.loop.available ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
										...
										/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
											...
											style: {
												...primaryBtnStyle,
												...control.loop.taskReady ? {} : disabledBtnStyle
											},
											disabled: !control.loop.taskReady,
											title: control.loop.taskReady ? void 0 : t("ctl.needTask"),
											onClick: () => {
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							...
							children: ready ? t("pop.footer") : t("ctl.needTask")
						})
					]
				})] }) : null]
			});
