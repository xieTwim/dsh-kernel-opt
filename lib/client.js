				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							t("advice.verdict"),
							"：",
							round.review === "ok" ? `✓ ${t("advice.ok")}` : round.review
						]
					})
				]
			});
					...
					reviewedRounds.length > 0 || earlierReviews > 0 || control?.supervisor.enabled === true ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							reviewedRounds.length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								...
								children: [...reviewedRounds].reverse().map((round) => {
									const kind = reviewKind(round);
									...
									return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										...
										children: [
											...
											/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
												...
												children: kind === "audit" ? t("advice.audit") : kind === "challenge" ? t("advice.challenge") : kind === "wrapup" ? t("advice.wrapup") : t("advice.round", { n: round.round ?? "—" })
											}),
											round.review === "ok" ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
												style: { color: COLOR.ok },
