	...
	factory: (require) => {
		...
		*/
		...
		const zh = {
			...
			"uncollected.note": "⚠ 有 {count} 次评测经由本面板不收录的通道返回，没有进入下面的记录，也不计入迭代次数。曲线为空或偏少并不代表 Agent 没有测。",
		...
		const en = {
			...
			"uncollected.note": "⚠ {count} evaluation(s) came back through a channel this panel does not collect: they are missing from the record below and from the iteration count. An empty or short curve does not mean the agent measured nothing.",
		...
		*/
		...
		function Chart(props) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("svg", {
				...
				children: [
					...
					iterations.map((p, i) => {
						...
						return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("g", { children: [
							...
							clamped && i === worstClampedIndex ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("text", {
